...
def create_untracked(
    apps: state.StateApps, _schema_editor: BaseDatabaseSchemaEditor
) -> None:
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    'id',
                    BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID'),
                ),
                ...
                (
                    'prefix',
                    CharField(editable=False, max_length=11),
                ),
                (
                    'bottom_right_prefix',
                    GeneratedField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'source',
                    ForeignKey(
                        on_delete=PROTECT, related_name='+', to='wellplated.well'
                    ),
                ),
                (
                    'sink',
